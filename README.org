...
* HELLO👋
This is now abandoned my hyprland config has now moved to nixos. It has not changed much but I am no longer daily driving this exact setup [[https://github.com/TobyM7/nixos-config][is here]].
/My Desktop/
